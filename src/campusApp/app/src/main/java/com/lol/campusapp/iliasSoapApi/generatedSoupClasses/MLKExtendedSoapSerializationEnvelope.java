...
public class MLKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    static {
        classNames.put("urn:ilUserAdministration^^ilUserData",MLKilUserData.class);
        classNames.put("urn:ilUserAdministration^^ilOperation",MLKilOperation.class);
        classNames.put("urn:ilUserAdministration^^intArray",MLKintArray.class);
        classNames.put("urn:ilUserAdministration^^stringArray",MLKstringArray.class);
        classNames.put("urn:ilUserAdministration^^ilOperations",MLKilOperations.class);
    } 
    ...
    public static void setDateTimeConverter(MLKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MLKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MLKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MLKDateTimeConverter dateTimeConverter = new MLKStandardDateTimeConverter();

    public MLKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MLKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MLKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MLKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public SoapObject GetSoapObject(Element detailElement) {
        ...
        catch (java.lang.Exception e)
        {
			if(enableLogging)
			{
				android.util.Log.e(MLKExtendedSoapSerializationEnvelope.TAG,"Error occured",e);
			}
        }
        return null;
    }
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MLKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MLKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
