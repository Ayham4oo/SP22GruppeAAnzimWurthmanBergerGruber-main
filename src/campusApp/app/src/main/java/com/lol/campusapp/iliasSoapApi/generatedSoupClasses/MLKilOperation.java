...
public  class MLKilOperation extends AttributeContainer implements KvmSerializable
{
    ...
    public void loadFromSoap(java.lang.Object paramObj,MLKExtendedSoapSerializationEnvelope __envelope)
    {
        if (paramObj == null)
            return;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,MLKExtendedSoapSerializationEnvelope __envelope)
    {
