...
public class MLKstringArray extends Vector<String> implements KvmSerializable,HasAttributes
{
    private transient java.lang.Object __source;

    public MLKstringArray()
    {
    }

    public MLKstringArray(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public MLKstringArray(java.util.Collection< String> initialCapactiy)
    {
        super(initialCapactiy);
    }
