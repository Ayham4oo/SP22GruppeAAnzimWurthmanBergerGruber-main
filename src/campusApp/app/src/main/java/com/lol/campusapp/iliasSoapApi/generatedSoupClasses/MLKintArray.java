...
public class MLKintArray extends Vector<Integer> implements KvmSerializable,HasAttributes
{
    ...
    public MLKintArray(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public MLKintArray(java.util.Collection< Integer> initialCapactiy)
    {
        super(initialCapactiy);
    }
